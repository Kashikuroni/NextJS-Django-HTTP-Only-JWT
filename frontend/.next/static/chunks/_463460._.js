(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_463460._.js", {
...
"[project]/src/components/Forms/LoginForm/LoginForm.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const LoginForm = ()=>{
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$backend$2d$api$2f$authApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].login(formData);
            router.push("/");
        } catch (error) {
            setError(error);
            console.error(error);
...
_s(LoginForm, "gGz2gwJJyVHKsl9SnGEY9iM1djY=", false, function() {
    return [
...
//# sourceMappingURL=_463460._.js.map