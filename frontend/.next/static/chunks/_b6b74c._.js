(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_b6b74c._.js", {
...
const BaseInput = ({ id, type = "text", name, label, value, onChange, placeholder, required = false, ...props })=>{
    ...
    const inputStyle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$classnames$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("w-full py-1 text-s px-2 bg-transparent", "border-2 rounded-md", error ? "border-red-500" : "border-gray-300", "placeholder-gray-300", "hover:ring-blue-400 hover:ring hover:border-transparent", "focus:ring-blue-400 focus:ring focus:border-transparent", "transition-all duration-300 ease-in-out", "appearance-none outline-none");
...
"[project]/src/components/Forms/RegisterForm/RegisterForm.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const RegisterForm = ()=>{
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$backend$2d$api$2f$authApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].register(formData);
...
_s(RegisterForm, "GvK6kvnHywpUPglixHH+iPLkv2Q=", false, function() {
    return [
...
//# sourceMappingURL=_b6b74c._.js.map